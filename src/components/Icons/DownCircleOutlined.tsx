...
const DownCircleOutlined = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="64 64 896 896" focusable="false" width="1em" height="1em" fill="currentColor" aria-hidden="true" {...props}>
